...
def run_plugin():
    ...
    logger.info('------------ Called Advanced Emulator Launcher Plugin: GameFAQs Scraper ------------')
    ...
    parser = argparse.ArgumentParser(prog='script.ael.gamefaqs')
    ...
    logger.debug('Advanced Emulator Launcher Plugin: GameFAQs Scraper -> exit')
